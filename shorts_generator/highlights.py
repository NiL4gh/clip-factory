...
def get_highlights(
    ...
    schema = (
        ...
        '    "hook_text": "Write a 3-7 word scroll-stopping VIEWER HOOK — a reaction, revelation, or tease that makes someone psychologically compelled to watch. Think of it as the overlay text on a viral TikTok: short, punchy, creates curiosity or emotion. Examples: \\"The [TOPIC] nobody mentions\\", \\"Why [BELIEF] is backwards\\", \\"He finally admits it\\", \\"This flips everything\\". Do NOT describe what happens in the clip — hook the viewer, do not summarize the content. Must be grounded in what the clip actually delivers so it does not feel like clickbait after watching.",\n'
