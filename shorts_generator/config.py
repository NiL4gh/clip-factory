...
LLM_CATALOG = [
    {"label": "♊ Google Gemini 2.5 Flash (API)",
     ...
     "repo": "google",
     "gpu_layers": 0},
    {"label": "⚡ Groq Llama 3 8B (API)",
     "filename": "api:groq:llama3-8b-8192",
     "repo": "groq",
     "gpu_layers": 0},
    {"label": "🌐 OpenRouter Llama 3 (API)",
     "filename": "api:openrouter:meta-llama/llama-3-8b-instruct",
     "repo": "openrouter",
     "gpu_layers": 0},
    {"label": "🧠 GLM 4 Flash (API)",
     ...
     "repo": "zhipu",
     "gpu_layers": 0},
    {"label": "🦙 Ollama Llama 3 (Local API)",
     "filename": "api:ollama:llama3",
     "repo": "ollama",
     "gpu_layers": 0},
